 ...
 * currently exist.  The function does not try to create a dentry and 
 * if one is found it doesn't try to revalidate it.
 *
 ...
 * i_rwsem held, and will take the i_rwsem itself if necessary.
 *  Unlike try_lookup_noperm() it *does* revalidate the dentry if it
 *   already existed.
 */
